  ...
  React.useEffect(() => {
    const observer = new MutationObserver((mutations) => {
      mutations.forEach((mutation) => {
        ...
        if (
          (!participantButton && mutation.addedNodes.length) ||
          (!handRaisedButton && mutation.addedNodes.length)
        ) {
          ...
          if (targetElement) {
            ...
            newParticipantButton.className = 'lk-button participant-button';
            newParticipantButton.addEventListener('click', () => toggleDrawer());
            newParticipantButton.innerHTML = `
            ...
            targetElement.appendChild(newParticipantButton);
