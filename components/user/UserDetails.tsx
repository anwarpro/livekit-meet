    ...
    <div>
      ...
      >
        <div className="title d-flex align-items-center mt-4 ps-5">
            ...
            <Typography fontWeight="bold" className='ms-3' fontSize="18px">Update User</Typography>
          </div>
        ...
        >
            <Typography fontWeight="bold" fontSize="16px" className='mb-2'>Name</Typography>
            <TextField
                hiddenLabel
                ...
                size='small'
              />
              <Typography fontWeight="bold" fontSize="16px" className='mt-4 mb-2'>Email</Typography>
            <TextField
                hiddenLabel
                id="filled-hidden-label-small"
                ...
                size='small'
              />
            <Typography fontWeight="bold" fontSize="16px" className='mb-2 mt-4'>Role</Typography>
            ...
            <Typography fontWeight="bold" fontSize="16px" className='mb-2 mt-4'>Team</Typography>
            <FormControl fullWidth>
              <Select
                labelId="demo-simple-select-label"
                id="demo-simple-select"
              ...
              >
                ...
                <MenuItem value={"Job Placement"}>Job Placement</MenuItem>
                <MenuItem value={"Phitron"}>Phitron</MenuItem>
              </Select>
            </FormControl>
            <Button variant="contained" className='mt-4 w-100' size='large' onClick={()=> handleUserEdit()}>Update User</Button>
        </Box>
      </CustomeModal>
    </div>
  );
